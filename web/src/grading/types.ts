/**
 * 评级系统类型定义（Kuantix 实现，规格对齐 docs/06 §3.4 / 上游 easy_tdx grading）。
 *
...
/** 评级场景：单标的回测 / 组合回测 / 参数寻优 */
export type GradeScenario = 'single' | 'portfolio' | 'optimize';
